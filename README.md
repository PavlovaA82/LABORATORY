...
Приложение отобразит наш идентификатор. Необходимо зафиксировать данный идентификатор, так как он потребуется в дальнейшем.Далее следует создать бота. Для этого необходимо осуществить поиск официального аккаунта `@BotFather`.

![image](https://github.com/user-attachments/assets/f52d5e20-c77c-43da-bd05-8d842aa72117)

Процесс создания бота осуществляется посредством последовательного ввода команды `/newbot` и последующего предоставления необходимых данных в ответ на запросы программного интерфейса мастера.
